...
from mlrl.boosting.cython.losses_label_wise cimport LabelWiseLoss, SparseLabelWiseLoss
from mlrl.boosting.cython.rule_evaluation_label_wise cimport LabelWiseRuleEvaluationFactory, \
    SparseLabelWiseRuleEvaluationFactory
...
cdef class DenseLabelWiseStatisticsProviderFactory(StatisticsProviderFactory):
    ...
    def __cinit__(self, SparseLabelWiseLoss loss_function not None, SparseEvaluationMeasure evaluation_measure not None,
                  LabelWiseRuleEvaluationFactory default_rule_evaluation_factory not None,
                  LabelWiseRuleEvaluationFactory regular_rule_evaluation_factory not None,
                  LabelWiseRuleEvaluationFactory pruning_rule_evaluation_factory not None, uint32 num_threads):
        """
...
cdef class SparseLabelWiseStatisticsProviderFactory(StatisticsProviderFactory):
    """
    A wrapper for the C++ class `SparseLabelWiseStatisticsProviderFactory`.
    """

    def __cinit__(self, SparseLabelWiseLoss loss_function not None,
                  SparseEvaluationMeasure evaluation_measure not None,
                  SparseLabelWiseRuleEvaluationFactory default_rule_evaluation_factory not None,
                  SparseLabelWiseRuleEvaluationFactory regular_rule_evaluation_factory not None,
                  SparseLabelWiseRuleEvaluationFactory pruning_rule_evaluation_factory not None, uint32 num_threads):
        """
        :param loss_function:                   The loss function to be used for calculating gradients and Hessians
        :param evaluation_measure:              The evaluation measure to be used for assessing the quality of
                                                predictions
        :param default_rule_evaluation_factory: The `SparseLabelWiseRuleEvaluationFactory` that allows to create
                                                instances of the class that should be used for calculating the
                                                predictions, as well as corresponding quality scores, of the default
                                                rule
        :param regular_rule_evaluation_factory: The `SparseLabelWiseRuleEvaluationFactory` that allows to create
                                                instances of the class that should be used for calculating the
                                                predictions, as well as corresponding quality scores, of all remaining
                                                rules
        :param pruning_rule_evaluation_factory: The `SparseLabelWiseRuleEvaluationFactory` that allows to create
                                                instances of the class that should be used for calculating the
        ...
        self.statistics_provider_factory_ptr = <unique_ptr[IStatisticsProviderFactory]>make_unique[SparseLabelWiseStatisticsProviderFactoryImpl](
            ...
            move(default_rule_evaluation_factory.get_sparse_label_wise_rule_rule_evaluation_factory_ptr()),
            move(regular_rule_evaluation_factory.get_sparse_label_wise_rule_rule_evaluation_factory_ptr()),
            move(pruning_rule_evaluation_factory.get_sparse_label_wise_rule_rule_evaluation_factory_ptr()), num_threads)
