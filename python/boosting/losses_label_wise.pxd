...
cdef extern from "cpp/losses/loss_label_wise.hpp" namespace "boosting" nogil:

    cdef cppclass ILabelWiseLoss(IMeasure):
        pass


cdef extern from "cpp/losses/loss_label_wise_logistic.hpp" namespace "boosting" nogil:

    cdef cppclass LabelWiseLogisticLossImpl"boosting::LabelWiseLogisticLoss"(ILabelWiseLoss):
        pass


cdef extern from "cpp/losses/loss_label_wise_squared_error.hpp" namespace "boosting" nogil:

    cdef cppclass LabelWiseSquaredErrorLossImpl"boosting::LabelWiseSquaredErrorLoss"(ILabelWiseLoss):
        pass


cdef extern from "cpp/losses/loss_label_wise_squared_hinge.hpp" namespace "boosting" nogil:
