...
class BoomerRunnable(RuleLearnerRunnable):
    ...
    def _create_learner(self, args):
        return Boomer(random_state=args.random_state, feature_format=args.feature_format,
                      ...
                      predictor=args.predictor, pruning=args.pruning, label_sub_sampling=args.label_sampling,
                      instance_sub_sampling=args.instance_sampling,
                      recalculate_predictions=args.recalculate_predictions, shrinkage=args.shrinkage,
                      feature_sub_sampling=args.feature_sampling, holdout=args.holdout,
