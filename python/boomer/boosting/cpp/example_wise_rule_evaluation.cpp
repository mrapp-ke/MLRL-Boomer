...
template<class T>
RegularizedExampleWiseRuleEvaluationImpl<T>::RegularizedExampleWiseRuleEvaluationImpl(const T& labelIndices,
                                                                                      float64 l2RegularizationWeight,
                                                                                      std::shared_ptr<Blas> blasPtr,
                                                                                      std::shared_ptr<Lapack> lapackPtr)
    : labelIndices_(labelIndices), l2RegularizationWeight_(l2RegularizationWeight), blasPtr_(std::move(blasPtr)),
      lapackPtr_(std::move(lapackPtr)), prediction_(nullptr), labelWisePrediction_(nullptr) {
