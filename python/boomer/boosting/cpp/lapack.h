...
class Lapack {
    ...
    public:
         ...
         *                                  coefficients in the matrix A. It will be used to temporarily store values
         *                                  computed by the DSYSV routine
         ...
         *                                  ordinates in the matrix A. The solution of the system of linear equations
