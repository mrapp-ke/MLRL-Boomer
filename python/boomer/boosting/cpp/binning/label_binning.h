...
class ILabelBinning {
    ...
    public:
         ...
         *
         * @param numPositiveBins   The number of bins to be used for labels that should be predicted positively. Must
         *                          be at least 1
         * @param numNegativeBins   The number of bins to be used for labels that should be predicted negatively. Must
         *                          be at least 1
         * @param statisticVector   A reference to an object of template type `T` that provides access to the gradients
         * @param observer          A reference to an object of type `IBinningObserver` that should be notified when a
