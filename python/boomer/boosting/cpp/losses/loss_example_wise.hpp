...
#include "../../../common/cpp/input/label_matrix.hpp"
#include "../../../common/cpp/measures/measure.hpp"
#include "../data/matrix_dense_numeric.hpp"
#include "../data/matrix_dense_example_wise.hpp"
...
namespace boosting {
     ...
     */
    class IExampleWiseLoss : public IMeasure {
