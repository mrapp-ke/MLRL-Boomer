...
class AbstractStatistics {
    ...
    public:
         ...
         *
         * @param labelIndices  A pointer to an array of type `intp`, shape `(num_considered_labels)`, representing the
         ...
         *                      search
         */
        virtual AbstractRefinementSearch* beginSearch(const intp* labelIndices);
