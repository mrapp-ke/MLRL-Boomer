...
class GenerateSyntheticDataRunnable(Runnable):
    ...
    def _run(self, args):
        ...
        meta_data = save_data_set_and_meta_data(args.output_dir, arff_file_name=dataset_name + '.' + SUFFIX_ARFF,
                                                xml_file_name=dataset_name + '.' + SUFFIX_XML, x=features, y=labels)
