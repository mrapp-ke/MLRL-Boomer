...
class ClassificationCmdBuilder(CmdBuilder):
    ...
    def print_marginal_probability_calibration_model(
        self, print_marginal_probability_calibration_model: bool | None = True
    ):
        """
    ...
    def save_marginal_probability_calibration_model(
        self, save_marginal_probability_calibration_model: bool | None = True
    ):
        """
        Configures whether textual representations of models for the calibration of marginal probabilities should be
    ...
    def print_joint_probability_calibration_model(self, print_joint_probability_calibration_model: bool | None = True):
        ...
        if print_joint_probability_calibration_model:
            self.add_control_argument(
                '--print-joint-probability-calibration-model', str(print_joint_probability_calibration_model).lower()
            )
    ...
    def save_joint_probability_calibration_model(self, save_joint_probability_calibration_model: bool | None = True):
        ...
        if save_joint_probability_calibration_model:
            ...
            self.add_control_argument(
                '--save-joint-probability-calibration-model', str(save_joint_probability_calibration_model).lower()
            )
