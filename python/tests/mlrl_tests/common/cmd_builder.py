...
class CmdBuilder:
    ...
    RESOURCE_DIR = TEST_DIR / 'res'

    DATA_DIR = RESOURCE_DIR / 'data'

    INPUT_DIR = RESOURCE_DIR / 'in'

    OUTPUT_DIR = RESOURCE_DIR / 'out'

    RESULT_DIR = TEST_DIR / 'tmp' / 'results'
    ...
    def result_dir(self) -> Path:
        """
        The path to the directory where experimental results should be saved.
        """
    ...
    def set_model_dir(self, model_dir: Optional[Path] = RESULT_DIR):
        """
    ...
    def set_parameter_save_dir(self, parameter_dir: Optional[Path] = RESULT_DIR):
        """
