...
#SBATCH --output=python/tests/res/tmp/n-estimators_50/max-depth_2/dataset_emotions/results/std_fold-%a.out
#SBATCH --error=python/tests/res/tmp/n-estimators_50/max-depth_2/dataset_emotions/results/std_fold-%a.err
#SBATCH --array=1-2
#SBATCH --time=2:30:00
