...
#SBATCH --output=python/tests/res/tmp/<worker-id>/n-estimators_100/max-depth_2/dataset_emotions/results/std.out
#SBATCH --error=python/tests/res/tmp/<worker-id>/n-estimators_100/max-depth_2/dataset_emotions/results/std.err
#SBATCH --time=2:30:00
