...
#SBATCH --output=python/tests/res/tmp/n-estimators_100/max-depth_4/max-leaf-nodes_4/dataset_emotions/results/std.out
#SBATCH --error=python/tests/res/tmp/n-estimators_100/max-depth_4/max-leaf-nodes_4/dataset_emotions/results/std.err
#SBATCH --time=2:30:00
