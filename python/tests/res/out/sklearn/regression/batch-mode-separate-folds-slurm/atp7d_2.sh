...
#SBATCH --output=python/tests/res/tmp/n-estimators_50/max-depth_4/max-leaf-nodes_4/dataset_atp7d/results/std_fold-%a.out
#SBATCH --error=python/tests/res/tmp/n-estimators_50/max-depth_4/max-leaf-nodes_4/dataset_atp7d/results/std_fold-%a.err
#SBATCH --array=1-2
#SBATCH --time=2:30:00
