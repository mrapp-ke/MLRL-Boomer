...
#SBATCH --output=python/tests/res/tmp/n-estimators_1/max-leaf-nodes_20/max_depth_5/dataset_enron/results/std_fold-%a.out
#SBATCH --error=python/tests/res/tmp/n-estimators_1/max-leaf-nodes_20/max_depth_5/dataset_enron/results/std_fold-%a.err
#SBATCH --array=1-2
#SBATCH --time=2:30:00
