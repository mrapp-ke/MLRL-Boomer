...
#SBATCH --output=python/tests/res/tmp/n-estimators_50/max-depth_2/dataset_atp7d-binary/results/std.out
#SBATCH --error=python/tests/res/tmp/n-estimators_50/max-depth_2/dataset_atp7d-binary/results/std.err
#SBATCH --time=2:30:00
