...
from common.cython.sampling import PartitionSampling, NoPartitionSampling
...
from common.types import DTYPE_UINT8, DTYPE_UINT32, DTYPE_FLOAT32
...
def create_partition_sampling() -> PartitionSampling:
    # TODO Implement
