...
class TabularDataCharacteristicExtension(Extension):
    ...
    @staticmethod
    def __create_argument_print_data_characteristics(mode: Mode) -> BoolArgument:
        return BoolArgument(
    ...
    @staticmethod
    def __create_argument_save_data_characteristics(mode: Mode) -> BoolArgument:
        return BoolArgument(
    ...
    def _get_arguments(self, mode: Mode) -> Set[Argument]:
        ...
        """
        return {
            self.__create_argument_print_data_characteristics(mode),
            self.__create_argument_save_data_characteristics(mode),
        }
    ...
    def __configure_log_sink(self, args: Namespace, experiment_builder: Experiment.Builder, mode: Mode):
        ...
        print_data_characteristics, options = self.__create_argument_print_data_characteristics(
    ...
    def __configure_csv_file_sink(self, args: Namespace, experiment_builder: Experiment.Builder, mode: Mode):
        ...
        save_data_characteristics, options = self.__create_argument_save_data_characteristics(
