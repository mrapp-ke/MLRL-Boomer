...
class TabularDataCharacteristicExtension(Extension):
    ...
    PRINT_DATA_CHARACTERISTICS = BoolArgument(
        ...
        true_options={
            DataCharacteristics.OPTION_EXAMPLES,
            DataCharacteristics.OPTION_FEATURES,
            DataCharacteristics.OPTION_NUMERICAL_FEATURES,
            DataCharacteristics.OPTION_NOMINAL_FEATURES,
            DataCharacteristics.OPTION_FEATURE_DENSITY,
            DataCharacteristics.OPTION_FEATURE_SPARSITY,
    ...
    def __configure_log_sink(self, args: Namespace, experiment_builder: Experiment.Builder):
        ...
        print_data_characteristics, options = self.PRINT_DATA_CHARACTERISTICS.get_value_and_options(
    ...
    def __configure_csv_file_sink(self, args: Namespace, experiment_builder: Experiment.Builder):
        ...
        save_data_characteristics, options = self.SAVE_DATA_CHARACTERISTICS.get_value_and_options(
