...
REGRESSION_EVALUATION_MEASURES = [
    Measure(
        option_key=TabularEvaluationResult.OPTION_MEAN_ABSOLUTE_ERROR,
    ...
    Measure(
        option_key=TabularEvaluationResult.OPTION_MEAN_SQUARED_ERROR,
    ...
    Measure(
        option_key=TabularEvaluationResult.OPTION_MEDIAN_ABSOLUTE_ERROR,
    ...
    Measure(
        option_key=TabularEvaluationResult.OPTION_MEAN_ABSOLUTE_PERCENTAGE_ERROR,
