...
from mlrl.testbed.evaluation import ARGUMENT_ENABLE_ALL, ARGUMENT_HAMMING_LOSS, ARGUMENT_HAMMING_ACCURACY, \
    ARGUMENT_SUBSET_ZERO_ONE_LOSS, ARGUMENT_SUBSET_ACCURACY, ARGUMENT_MICRO_PRECISION, ARGUMENT_MICRO_RECALL, \
    ARGUMENT_MICRO_F1, ARGUMENT_MICRO_JACCARD, ARGUMENT_MACRO_PRECISION, ARGUMENT_MACRO_RECALL, ARGUMENT_MACRO_F1, \
...
PRINT_EVALUATION_VALUES: Dict[str, Set[str]] = {
    BooleanOption.TRUE.value: {
        ARGUMENT_ENABLE_ALL, ARGUMENT_HAMMING_LOSS, ARGUMENT_HAMMING_ACCURACY, ARGUMENT_SUBSET_ZERO_ONE_LOSS,
        ...
        ARGUMENT_MEDIAN_ABSOLUTE_ERROR, ARGUMENT_MEAN_ABSOLUTE_PERCENTAGE_ERROR, ARGUMENT_RANK_LOSS,
        ARGUMENT_COVERAGE_ERROR, ARGUMENT_LABEL_RANKING_AVERAGE_PRECISION, ARGUMENT_DISCOUNTED_CUMULATIVE_GAIN,
        ARGUMENT_NORMALIZED_DISCOUNTED_CUMULATIVE_GAIN, ARGUMENT_DECIMALS, ARGUMENT_PERCENTAGE
    },
...
STORE_EVALUATION_VALUES: Dict[str, Set[str]] = {
    BooleanOption.TRUE.value: {
        ...
        ARGUMENT_MEDIAN_ABSOLUTE_ERROR, ARGUMENT_MEAN_ABSOLUTE_PERCENTAGE_ERROR, ARGUMENT_RANK_LOSS,
        ARGUMENT_COVERAGE_ERROR, ARGUMENT_LABEL_RANKING_AVERAGE_PRECISION, ARGUMENT_DISCOUNTED_CUMULATIVE_GAIN,
        ARGUMENT_NORMALIZED_DISCOUNTED_CUMULATIVE_GAIN, ARGUMENT_TRAINING_TIME, ARGUMENT_PREDICTION_TIME,
...
PRINT_DATA_CHARACTERISTICS_VALUES: Dict[str, Set[str]] = {
    BooleanOption.TRUE.value: {
        ARGUMENT_EXAMPLES, ARGUMENT_FEATURES, ARGUMENT_NUMERICAL_FEATURES, ARGUMENT_NOMINAL_FEATURES,
        ARGUMENT_FEATURE_DENSITY, ARGUMENT_FEATURE_SPARSITY, ARGUMENT_LABELS, ARGUMENT_LABEL_DENSITY,
        ARGUMENT_LABEL_SPARSITY, ARGUMENT_LABEL_IMBALANCE_RATIO, ARGUMENT_LABEL_CARDINALITY,
...
PRINT_PREDICTION_CHARACTERISTICS_VALUES: Dict[str, Set[str]] = {
    BooleanOption.TRUE.value: {
        ARGUMENT_LABELS, ARGUMENT_LABEL_DENSITY, ARGUMENT_LABEL_SPARSITY, ARGUMENT_LABEL_IMBALANCE_RATIO,
        ARGUMENT_LABEL_CARDINALITY, ARGUMENT_DISTINCT_LABEL_VECTORS, ARGUMENT_DECIMALS, ARGUMENT_PERCENTAGE
    },
    BooleanOption.FALSE.value: {}
}
...
PRINT_RULES_VALUES: Dict[str, Set[str]] = {
    BooleanOption.TRUE.value: {
        ARGUMENT_PRINT_FEATURE_NAMES, ARGUMENT_PRINT_LABEL_NAMES, ARGUMENT_PRINT_NOMINAL_VALUES, ARGUMENT_PRINT_BODIES,
        ARGUMENT_PRINT_HEADS
    },
    BooleanOption.FALSE.value: {}
}
