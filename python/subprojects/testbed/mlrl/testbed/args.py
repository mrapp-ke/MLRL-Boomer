...
PRINT_EVALUATION_VALUES: Dict[str, Set[str]] = {
    BooleanOption.TRUE.value: {
        ARGUMENT_HAMMING_LOSS, ARGUMENT_HAMMING_ACCURACY, ARGUMENT_SUBSET_ZERO_ONE_LOSS, ARGUMENT_SUBSET_ACCURACY,
        ARGUMENT_MICRO_PRECISION, ARGUMENT_MICRO_RECALL, ARGUMENT_MICRO_F1, ARGUMENT_MICRO_JACCARD,
        ARGUMENT_MACRO_PRECISION, ARGUMENT_MACRO_RECALL, ARGUMENT_MACRO_F1, ARGUMENT_MACRO_JACCARD,
