...
from python.subprojects.testbed.mlrl.testbed.data import AttributeType

from mlrl.common.config.options import Options

from mlrl.testbed.data import Attribute, MetaData, save_arff_file
        ...
        def write_output(self, problem_type: ProblemType, meta_data: MetaData, data_split: DataSplit,
            ...
            if issubclass(predictions.dtype.type, np.integer):
                if problem_type == ProblemType.CLASSIFICATION:
                    ...
                    nominal_values = np.unique(predictions)
                else:
