...
class Fold:
    """
    Provides information about a one or several folds of a dataset, i.e., a specific subset of the examples that are
    ...
    Attributes:
        ...
        is_train_test_separated:    True, if the training data is separated from the test data, False otherwise
    """
    index: Optional[int]
    num_folds: bool
    is_last_fold: bool
