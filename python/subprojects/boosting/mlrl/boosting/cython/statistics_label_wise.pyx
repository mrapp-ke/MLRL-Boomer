...
from mlrl.boosting.cython.losses_label_wise cimport LabelWiseLossFactory
...
cdef class DenseLabelWiseStatisticsProviderFactory(StatisticsProviderFactory):
    ...
    def __cinit__(self, LabelWiseLossFactory loss_factory not None,
        ...
        """
        :param loss_factory:                    The `LabelWiseLossFactory` that allows to create instances of the class
                                                that should be used for calculating gradients and Hessians
        :param evaluation_measure_factory:      The `EvaluationMeasureFactory` that allows to create instances of the
                                                class that should be used for assessing the quality of predictions
