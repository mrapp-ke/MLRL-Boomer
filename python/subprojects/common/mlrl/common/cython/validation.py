...
def assert_greater(name: str, value, threshold):
    """
    Raises an `AssertionError` if a given value is not greater than a specific threshold.
...
def assert_greater_or_equal(name: str, value, threshold):
    """
    Raises an `AssertionError` if a given value is not greater or equal to a specific threshold.
...
def assert_less(name: str, value, threshold):
    """
    Raises an `AssertionError` if a given value is not less than a specific threshold.
...
def assert_less_or_equal(name: str, value, threshold):
    """
    Raises an `AssertionError` if a given value is not less or equal to a specific threshold.
...
def assert_multiple(name: str, value, other):
    """
    Raises an `AssertionError` if a given value is not a multiple of another value.
...
def assert_not_none(name: str, value):
    """
    Raises an `AssertionError` if a given value is None.
