...
sources = [
    ...
    'common/cpp/data/vector_binned_dense.cpp',
    ...
    'common/cpp/rule_evaluation/score_vector_binned_dense.cpp',
    'common/cpp/rule_evaluation/score_vector_label_wise_dense.cpp',
    'common/cpp/rule_evaluation/score_vector_label_wise_binned_dense.cpp',
    ...
    'boosting/cpp/rule_evaluation/rule_evaluation_example_wise_binning.cpp',
    'boosting/cpp/rule_evaluation/rule_evaluation_label_wise_regularized.cpp',
    'boosting/cpp/rule_evaluation/rule_evaluation_label_wise_binning.cpp',
    ...
    'boosting/cpp/binning/label_binning_equal_width.cpp',
