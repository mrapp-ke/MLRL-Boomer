...
sources = [
    ...
    'boomer/common/cpp/statistics/statistics_subset_decomposable.cpp',
    ...
    'boomer/boosting/cpp/losses/loss_label_wise_common.cpp',
    ...
    'boomer/boosting/cpp/statistics/statistics_example_wise.cpp',
