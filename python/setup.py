...
sources = [
    ...
    'boomer/common/cpp/input/view_c_contiguous.cpp',
    'boomer/common/cpp/input/view_csc.cpp',
    'boomer/common/cpp/input/view_csr.cpp',
    'boomer/common/cpp/input/view_fortran_contiguous.cpp',
