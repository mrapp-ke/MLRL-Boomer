...
sources = [
    ...
    'boomer/common/cpp/rule_induction/rule_induction_top_down.cpp',
    'boomer/common/cpp/rule_induction/rule_model_induction_sequential.cpp',
    ...
    'boomer/boosting/cpp/output/predictor_classification_label_wise.cpp',
    'boomer/boosting/cpp/output/predictor_classification_example_wise.cpp',
    ...
    'boomer/seco/cpp/output/predictor_classification_label_wise.cpp',
