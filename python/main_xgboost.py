...
def configure_argument_parser(p: argparse.ArgumentParser):
    ...
    p.add_argument('--learning-rate', type=float, default=1.0, help='The learning rate to be used')
    p.add_argument('--reg-lambda', type=float, default=0.0, help='The L2 regularization weight to be used')
