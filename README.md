...
| `--pruning`                  | Yes       | `None`                     | The name of the strategy to be used for pruning rules. Must be `irep` or `None`. Does only have an effect if the parameter `--instance-sub-sampling` or `--holdout` is used.                                                                                                      |
