...
| `--feature-binning`          | Yes       | `none`                     | The name of the strategy to be used for feature-binning. Must be `equal-width`, `equal-frequency` or `None`. Additional arguments may be provided as a dictionary, e.g. `binning{\"num_bins\":0.5}`                                                         |
