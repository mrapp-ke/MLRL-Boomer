...
| `--num-threads-rule-refinement`  | Yes       | `1`                   | The number of threads to be used to search for potential refinements of rules. Must be at least `1` or `-1`, if the number of cores that are available on the machine should be used.                                                                                                                                                                                                                                 |
| `--num-threads-statistic-update` | Yes       | `1`                   | The number of threads to be used to calculate gradients and Hessians. Must be at least `1` or `-1`, if the number of cores that are available on the machine should be used.                                                                                                                                                                                                                                          |
