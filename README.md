...
| `--early-stopping`               | Yes       | `None`                | The name of the strategy to be used for early stopping. Must be `loss` or `None`, if no early stopping should be used. Additional arguments may be provided as a dictionary, e.g., `loss{'min_rules':100,'update_interval':1,'stop_interval':1,'num_past':50,'num_recent':50,'aggregation':'min','tolerance':0.001}`. Does only have an effect if the parameter `--holdout` is not set to `None`.                     |                                                                                
| `--label-sampling`               | Yes       | `None`                | The name of the strategy to be used for label sampling. Must be `without-replacement` or `None`. Additional arguments may be provided as a dictionary, e.g. `without-replacement{'num_samples':5}`.                                                                                                                                                                                                                   |                                                       
| `--instance-sampling`            | Yes       | `None`                | The name of the strategy to be used for instance sub-sampling. Must be `with-replacement`, `without-replacement`, `stratified-label-wise`, `stratified-example-wise` or `None`. Additional arguments may be provided as a dictionary, e.g. `with-replacement{'sample_size':0.5}`.                                                                                                                                     |
...
| `--feature-sub-sampling`         | Yes       | `without-replacement` | The name of the strategy to be used for feature sub-sampling. Must be `without-replacement` or `None`. Additional arguments may be provided as a dictionary, e.g. `without-replacement{'sample_size':0.5}`.                                                                                                                                                                                                           |
| `--holdout`                      | Yes       | `None`                | The name of the strategy to be used for creating a holdout set. Must be `random`, `stratified-label-wise`, `stratified-example-wise` or `None`, if no holdout set should be used. Additional arguments may be provided as a dictionary, e.g. `random{'holdout_set_size':0.5'}`.                                                                                                                                       |
...
| `--label-binning`                | Yes       | `auto`                | The name of the strategy to be used for gradient-based label binning. Must be `auto`, `equal-width` or `None`, if no label binning should be used. Additional arguments may be provided as a dictionary, e.g. `equal-width{'bin_ratio':0.04,'min_bins':1,'max_bins':8`. If `auto` is used, the most suitable strategy is chosen automatically based on the loss function and the type of rule heads.                  |
