...
| `--instance-sampling`        | Yes       | `with-replacement`         | The name of the strategy to be used for instance sub-sampling. Must be `with-replacement`, `without-replacement`, `stratified-label-wise`, `stratified-example-wise` or `None`. Additional arguments may be provided as a dictionary, e.g. `with-replacement{'sample_size':0.5}`.                                                                                                                                     |
