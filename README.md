...
| `--label-sub-sampling`                | Yes       | `None`                     | The name of the strategy to be used for label sub-sampling. Must be `random-label-selection` or `None`.                                                                                                                                                        |
| `--label-sub-sampling-num-samples`    | Yes       | `1`                        | The number of samples to be used for label sub-sampling. Must be at least 1 and less than the number of labels in the data set.                                                                                                                                |                                                       
| `--instance-sub-sampling`             | Yes       | `bagging`                  | The name of the strategy to be used for instance sub-sampling. Must be `bagging`, `random-instance-selection` or `None`.                                                                                                                                       |
| `--instance-sub-sampling-sample-size` | Yes       | `0.0`                      | The fraction of examples to be used for instance sub-sampling. Must be greater than `0` and less than `1` or `0`, if the default value should be used.                                                                                                         |
| `--feature-sub-sampling`              | Yes       | `random-feature-selection` | The name of the strategy to be used for feature sub-sampling. Must be `random-feature-selection` or `None`.                                                                                                                                                    |
| `--feature-sub-sampling-sample-size`  | Yes       | `0.0`                      | The fraction of feature to be used for feature sub-sampling. Must be greater than `0` and less than `1`, or `0`, if the default value should be used.                                                                                                          |
