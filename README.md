...
| `--recalculate-predictions`      | Yes       | True                | True, if the predictions of rules should be recalculated on the entire training data, if the argument --instance-sampling is not set to `None`, False otherwise.                                                                                                                                                                  |
