...
| `--feature-binning`          | Yes       | `none`                     | The name of the strategy to be used for feature-binning. Must be `equal-width`, `equal-frequency` or `None`. Additional arguments may be provided as a dictionary, e.g. `binning{\"bin_ratio\":0.5}`                                                         |
