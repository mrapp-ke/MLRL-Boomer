...
| `--holdout`                  | Yes       | `None`                     | The name of the strategy to be used for creating a holdout set. Must be `random` or `None`, if no holdout set should be used. Additional arguments may be provided as a dictionary, e.g. `random{'holdout_set_size':0.5'}`.                                                                                                                                                                                           |
