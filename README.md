...
| `--loss`                     | Yes       | `macro-logistic-loss`      | The name of the loss function to be minimized during training. Must be `macro-squared-error-loss` or `macro-logistic-loss` or `example-based-logistic-loss`.                                                                                                   |
