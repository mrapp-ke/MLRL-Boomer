...
| `--num-threads-update`       | Yes       | `1`                        | The number of threads to be used for calculating gradients and Hessians. Must be at least `1` or `-1`, if the number of cores that are available on the machine should be used.                                                                                                   |
