...
| `--head-type`                    | Yes       | `None`                | The type of the rule heads that should be used. Must be `single-label`, `complete` or `None`. If `None` is used, the most suitable type of rule heads is chosen automatically based on the loss function.                                                                                                                                                                                                             |
