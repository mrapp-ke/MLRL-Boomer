...
| `--label-sub-sampling-num-samples`    | Yes       | `1`                        | The number of samples to be used for label sub-sampling. Must be at least 1.                                                                                                                                                                                   |                                                       
...
| `--instance-sub-sampling-sample-size` | Yes       | `0.0`                      | The fraction of examples to be used for instance sub-sampling. Must be greater than `0` and less or equal to `1` or `0`, if the default value should be used.                                                                                                  |
...
| `--feature-sub-sampling-sample-size`  | Yes       | `0.0`                      | The fraction of feature to be used for feature sub-sampling. Must be greater than `0` and less or equal to `1`, or `0`, if the default value should be used.                                                                                                   |
