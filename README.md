...
| `--instance-sub-sampling`    | Yes       | `bagging`                  | The name of the strategy to be used for instance sub-sampling. Must be `bagging`, `random-instance-selection`, `stratified-label-wise` or `None`. Additional arguments may be provided as a dictionary, e.g. `bagging{'sample_size':0.5}`.                                                                                                                                                                            |
