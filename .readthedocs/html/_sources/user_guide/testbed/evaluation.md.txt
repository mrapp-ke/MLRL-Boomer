...
````{tab} BOOMER
   ...
   mlrl-testbed mlrl.boosting \
       --data-dir /path/to/datasets/ \
       --dataset dataset-name \
       --data-split 'cross-validation{num_folds=5}'
   ```
````
...
````{tab} BOOMER
   ...
   mlrl-testbed mlrl.boosting \
       --data-dir /path/to/datasets/ \
       --dataset dataset-name \
       --data-split 'cross-validation{num_folds=5,first_fold=2,last_fold=2}'
   ```
````
