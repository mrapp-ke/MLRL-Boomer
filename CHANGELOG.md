...
* A new parameter `--post-optimization` has been added. It allows to optimize each rule in a previously learned model by being relearned in the context of the other rules (`sequential`).
