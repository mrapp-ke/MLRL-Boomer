...
This document is intended for users and developers that are interested in the algorithm's implementation. For a detailed description of the used methodology, please refer to the :ref:`references` section.
