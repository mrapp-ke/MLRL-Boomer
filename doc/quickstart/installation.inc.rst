...
.. warning::
    Currently, the above package is only available for Linux (supporting x86_64 and aarch64 architectures) and MacOS (supporting the x86_64 architecture). Support for Windows is planned for future releases.
