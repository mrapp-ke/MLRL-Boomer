...
* The predictive performance in terms of commonly used evaluation measures can be assessed by using predefined splits of a dataset into training and test data or `cross validation <https://en.wikipedia.org/wiki/Cross-validation_(statistics)>`_.
