...
namespace seco {
     ...
     * https://sci2s.ugr.es/keel/pdf/algorithm/congreso/ml-95-ripper.pdf). A proof is provided in the paper "Roc 'n'
     * Rule Learning — Towards a Better Understanding of Covering Algorithms", Fürnkranz, Flach 2005 (see
