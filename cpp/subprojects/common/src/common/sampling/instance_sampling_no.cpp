...
std::unique_ptr<IWeightVector> NoInstanceSubSampling::subSample(const SinglePartition& partition, RNG& rng,
...
std::unique_ptr<IWeightVector> NoInstanceSubSampling::subSample(const BiPartition& partition, RNG& rng,
                                                                const IRandomAccessLabelMatrix& labelMatrix,
                                                                const IStatistics& statistics) const {
