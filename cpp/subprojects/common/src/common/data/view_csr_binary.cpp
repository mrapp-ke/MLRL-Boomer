...
BinaryCsrConstView::BinaryCsrConstView(uint32 numRows, uint32 numCols, uint32* indptr, uint32* colIndices)
    : numRows_(numRows), numCols_(numCols), indptr_(indptr), colIndices_(colIndices) {}
...
BinaryCsrView::BinaryCsrView(uint32 numRows, uint32 numCols, uint32* indptr, uint32* colIndices)
