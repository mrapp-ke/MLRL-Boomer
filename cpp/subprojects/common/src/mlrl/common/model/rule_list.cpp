...
void RuleList::Rule::visit(IBody::EmptyBodyVisitor emptyBodyVisitor,
    ...
    headPtr_->visit(complete64BitHeadVisitor, partial64BitHeadVisitor);
}
...
void RuleList::visit(IBody::EmptyBodyVisitor emptyBodyVisitor, IBody::ConjunctiveBodyVisitor conjunctiveBodyVisitor,
    ...
    for (auto it = this->cbegin(); it != this->cend(); it++) {
        const Rule& rule = *it;
        rule.visit(emptyBodyVisitor, conjunctiveBodyVisitor, complete64BitHeadVisitor, partial64BitHeadVisitor);
    }
}
