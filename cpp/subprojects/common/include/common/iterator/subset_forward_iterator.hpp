...
/**
 * An iterator adaptor that adapts an iterator, which provides access to indices, such that it acts as a forward
 * iterator that returns only those indices that are provided by a second iterator.
 *
 * @tparam Iterator         The type of the iterator that provides access to the original indices
 * @tparam IndexIterator    The type of the iterator that provides access to the subset of indices
 */
template<typename Iterator, typename IndexIterator>
class IndexSubsetForwardIterator {
    ...
    public:
        ...
        /**
         * @param begin         An iterator to the beginning of the original indices
         * @param end           An iterator to the end of the original indices
         ...
         */
        IndexSubsetForwardIterator(Iterator begin, Iterator end, IndexIterator indicesBegin, IndexIterator indicesEnd)
         ...
         */
        IndexSubsetForwardIterator<Iterator, IndexIterator>& operator++() {
            indexIterator_++;
         ...
         * @return A reference to an iterator that refers to the next element
         */
        IndexSubsetForwardIterator<Iterator, IndexIterator>& operator++(int n) {
            indexIterator_++;
         ...
         */
        bool operator!=(const IndexSubsetForwardIterator<Iterator, IndexIterator>& rhs) const {
...
/**
 * Creates and returns a new `IndexSubsetForwardIterator`
 *
 * @tparam Iterator         The type of the iterator that provides access to the original indices
 * @tparam IndexIterator    The type of the iterator that provides access to the subset of indices
 * @param begin             An iterator to the beginning of the original indices
 ...
 * @param indicesBegin      An iterator to the beginning of the subset of indices
 * @param indicesEnd        An iterator to the end of the subset of indices
 * @return                  The `IndexSubsetForwardIterator` that has been created
 */
template<typename Iterator, typename IndexIterator>
static inline IndexSubsetForwardIterator<Iterator, IndexIterator> make_subset_forward_iterator(Iterator begin,
        Iterator end, IndexIterator indicesBegin, IndexIterator indicesEnd) {
    return IndexSubsetForwardIterator<Iterator, IndexIterator>(begin, end, indicesBegin, indicesEnd);
}
