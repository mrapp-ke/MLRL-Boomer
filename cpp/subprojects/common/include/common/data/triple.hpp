...
struct Triple final {
    ...
    /**
     * Creates and returns a new triple that results from adding a specific value to the first, second and third value
    ...
    /**
     * Creates and returns a new triple that results from adding the first, second and third value of a specific triple
     * to the first, second and third value of an existing triple, respectively.
     *
     * @param lhs   The original triple
     * @param rhs   A reference to the triple, whose first, second and third value should be added
     * @return      The triple that has been created
    ...
    /**
     * Creates and returns a new triple that results from subtracting a specific value from the first, second and third
     * value of an existing triple, respectively.
     *
     * @param lhs   The original triple
     * @param rhs   A reference to the value to be subtracted
     * @return      The triple that has been created
    ...
    /**
     * Creates and returns a new triple that results from subtracting the first, second and third value of a specific
     * triple from the first, second and third value of an existing triple, respectively.
     *
     * @param lhs   The original triple
     * @param rhs   A reference to the value to be subtracted
     * @return      The triple that has been created
    ...
    /**
     * Creates and returns a new triple that results from multiplying the first, second and third value of an existing
     * triple with a specific value.
     *
     * @param lhs   The original triple
     * @param rhs   A reference to the value to be multiplied by
     * @return      The triple that has been created
