...
namespace util {
     ...
     *
     * The mean is calculated as `small + ((large - small) * 0.5`, instead of `(small + large) / 2`, to prevent
     * overflows.
     *
    ...
    /**
     * Allows to compute the arithmetic mean of several floating point values `x_1, ..., x_n` in an iterative manner,
