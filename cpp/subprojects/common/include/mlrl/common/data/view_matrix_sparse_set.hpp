...
class SparseSetView : public Matrix {
    ...
    public:
         ...
         */
        typedef typename AllocatedListOfLists<IndexedValue<T>>::const_iterator const_iterator;

        /**
         * An iterator that provides access to the values in the view and allows to modify them.
         */
        typedef typename AllocatedListOfLists<IndexedValue<T>>::iterator iterator;
