...
namespace simd {
    ...
    extern template void copy<xsimd::neon64, uint32>(xsimd::neon64, const uint32*, uint32*, uint32);
    #else
    ...
    extern template void copy<xsimd::sse2, uint32>(xsimd::sse2, const uint32*, uint32*, uint32);
    ...
    extern template void copy<xsimd::avx, uint32>(xsimd::avx, const uint32*, uint32*, uint32);
    ...
    extern template void copy<xsimd::avx2, uint32>(xsimd::avx2, const uint32*, uint32*, uint32);
    ...
    extern template void copy<xsimd::avx512f, uint32>(xsimd::avx512f, const uint32*, uint32*, uint32);
    #endif
}
#endif
