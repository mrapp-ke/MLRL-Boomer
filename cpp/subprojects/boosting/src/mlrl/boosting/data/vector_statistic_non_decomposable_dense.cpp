...
namespace boosting {
    ...
    template class DenseNonDecomposableStatisticVector<float32, SimdMemoryAllocator, SimdVectorMath>;
    template class DenseNonDecomposableStatisticVector<float64, SimdMemoryAllocator, SimdVectorMath>;
#endif
}
