...
namespace boosting {
    ...
    class NoSparseDecomposableQuantization final : public IQuantization {
        private:
            ...
            std::unique_ptr<IQuantizationMatrix<SparseDecomposableStatisticView<StatisticType>>> quantizationMatrixPtr_;
        ...
        public:
            ...
            void visitQuantizationMatrix(
              ...
              std::optional<DenseNonDecomposableMatrixVisitor<float32>> denseNonDecomposable32BitVisitor,
              std::optional<DenseNonDecomposableMatrixVisitor<float64>> denseNonDecomposable64BitVisitor) override {
                visitInternally(quantizationMatrixPtr_, sparseDecomposable32BitVisitor, sparseDecomposable64BitVisitor);
            }
    };
            ...
            std::unique_ptr<IQuantization> create(
              const DenseDecomposableStatisticView<float32>& statisticMatrix) const override {
                return std::make_unique<NoDenseDecomposableQuantization<float32>>(
                  std::make_unique<NoQuantizationMatrix<DenseDecomposableStatisticView<float32>>>(statisticMatrix));
            }
            ...
            std::unique_ptr<IQuantization> create(
              const DenseDecomposableStatisticView<float64>& statisticMatrix) const override {
                return std::make_unique<NoDenseDecomposableQuantization<float64>>(
                  std::make_unique<NoQuantizationMatrix<DenseDecomposableStatisticView<float64>>>(statisticMatrix));
            }
            ...
            std::unique_ptr<IQuantization> create(
              const SparseDecomposableStatisticView<float32>& statisticMatrix) const override {
                return std::make_unique<NoSparseDecomposableQuantization<float32>>(
                  std::make_unique<NoQuantizationMatrix<SparseDecomposableStatisticView<float32>>>(statisticMatrix));
            }
            ...
            std::unique_ptr<IQuantization> create(
              const SparseDecomposableStatisticView<float64>& statisticMatrix) const override {
                return std::make_unique<NoSparseDecomposableQuantization<float64>>(
                  std::make_unique<NoQuantizationMatrix<SparseDecomposableStatisticView<float64>>>(statisticMatrix));
            }
