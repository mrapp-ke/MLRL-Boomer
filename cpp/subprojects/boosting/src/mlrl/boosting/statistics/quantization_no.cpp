...
namespace boosting {
    ...
    class NoDenseDecomposableQuantization final : public IQuantization {
        private:
            ...
            NoQuantizationMatrix<DenseDecomposableStatisticView<StatisticType>> quantizationMatrix_;
        ...
        public:
            ...
            NoDenseDecomposableQuantization(const DenseDecomposableStatisticView<StatisticType>& view)
