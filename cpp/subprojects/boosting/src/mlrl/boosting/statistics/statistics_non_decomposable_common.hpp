...
namespace boosting {
    ...
    class AbstractNonDecomposableStatistics
        : public AbstractBoostingStatistics<NonDecomposableBoostingStatisticsState<
                                              OutputMatrix, StatisticMatrix, QuantizationMatrix, ScoreMatrix, Loss>,
        ...
        public:
            ...
            AbstractNonDecomposableStatistics(std::unique_ptr<Loss> lossPtr,
                ...
                : AbstractBoostingStatistics<NonDecomposableBoostingStatisticsState<
                                               OutputMatrix, StatisticMatrix, QuantizationMatrix, ScoreMatrix, Loss>,
                                             EvaluationMeasure, NonDecomposableRuleEvaluationFactory>(
