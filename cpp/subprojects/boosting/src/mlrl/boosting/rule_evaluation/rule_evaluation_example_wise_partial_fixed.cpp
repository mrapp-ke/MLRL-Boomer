...
namespace boosting {
    ...
    class DenseExampleWiseFixedPartialRuleEvaluation final
        ...
        public:
            ...
            DenseExampleWiseFixedPartialRuleEvaluation(const IndexVector& labelIndices, uint32 numPredictions,
                ...
                : AbstractExampleWiseRuleEvaluation<DenseNonDecomposableStatisticVector, IndexVector>(numPredictions,
                                                                                                      lapack),
    ...
    std::unique_ptr<IRuleEvaluation<DenseNonDecomposableStatisticVector>>
      ExampleWiseFixedPartialRuleEvaluationFactory::create(const DenseNonDecomposableStatisticVector& statisticVector,
