...
namespace boosting {
    ...
    std::unique_ptr<IHeadConfig::IPreset<float32>> SingleOutputHeadConfig::create32Bit() const {
    ...
    std::unique_ptr<IHeadConfig::IPreset<float64>> SingleOutputHeadConfig::create64Bit() const {
