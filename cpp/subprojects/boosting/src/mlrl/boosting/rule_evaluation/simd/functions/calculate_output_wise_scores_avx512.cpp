...
namespace boosting {
    namespace simd {
        ...
        template void calculateOutputWiseScoresWeighted<xsimd::avx512f, float32>(xsimd::avx512f, const float32*,
                                                                                 const float32*, const uint32*,
                                                                                 float32*, uint32, float32, float32);
        template void calculateOutputWiseScoresWeighted<xsimd::avx512f, float64>(xsimd::avx512f, const float64*,
