#include "mlrl/boosting/rule_evaluation/rule_evaluation_example_wise_partial_dynamic.hpp"
    ...
    class DenseExampleWiseDynamicPartialRuleEvaluation final
        ...
        public:
            ...
            const IScoreVector& calculateScores(DenseExampleWiseStatisticVector& statisticVector) override {
                ...
                copyCoefficients(statisticVector.hessians_cbegin(), indexIterator, &this->dsysvTmpArray1_[0], n);
                addL2RegularizationWeight(&this->dsysvTmpArray1_[0], n, l2RegularizationWeight_);
