...
namespace boosting {
    ...
    std::unique_ptr<IHeadConfig::IPreset<float32>> CompleteHeadConfig::create32Bit() const {
    ...
    std::unique_ptr<IHeadConfig::IPreset<float64>> CompleteHeadConfig::create64Bit() const {
