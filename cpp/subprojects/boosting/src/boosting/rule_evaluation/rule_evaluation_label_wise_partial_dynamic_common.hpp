...
namespace boosting {
     ...
     */
    static inline constexpr float64 calculateThreshold(float64 minAbsScore, float64 maxAbsScore, float64 threshold,
                                                       float64 exponent) {
     ...
     */
    static inline constexpr float64 calculateWeightedScore(float64 score, float64 minAbsScore, float64 exponent) {
