...
namespace boosting {
     ...
     * them to a threshold.
     */
    class ScoreDiscretizationFunction : public IDiscretizationFunction {
        private:
    ...
    std::unique_ptr<IDiscretizationFunction> ScoreDiscretizationFunctionFactory::create() const {
