...
namespace boosting {
        ...
        protected:
            ...
            class StatisticsSubset final : public IStatisticsSubset {
                ...
                private:
                    ...
                    std::unique_ptr<IExampleWiseRuleEvaluation<StatisticVector>> ruleEvaluationPtr_;
    ...
    class AbstractExampleWiseStatistics : public AbstractExampleWiseImmutableStatistics<StatisticVector, StatisticView,
        ...
        public:
             ...
             */
            void setRuleEvaluationFactory(const IExampleWiseRuleEvaluationFactory& ruleEvaluationFactory) override {
