#include "boosting/sampling/instance_sampling_stratified_label_wise.hpp"
...
namespace boosting {
    ...
    /**
     * Implements stratified sampling for selecting a subset of the available training examples, such that for each
     * label the proportion of relevant and irrelevant examples is maintained.
     *
     * @tparam LabelMatrix      The type of the label matrix that provides random or row-wise access to the labels of
