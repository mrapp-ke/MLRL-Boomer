#include "boosting/sampling/instance_sampling_no.hpp"
...
namespace boosting {
    ...
    /**
     * An implementation of the class `IInstanceSampling` that does not perform any sampling, but assigns equal weights
     * to all examples.
     *
