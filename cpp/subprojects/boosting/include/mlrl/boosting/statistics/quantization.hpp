...
namespace boosting {
    ...
    class IQuantization {
        public:
            ...
            using DenseDecomposableMatrixVisitor =
              std::function<void(const IQuantizationMatrix<DenseDecomposableStatisticView<StatisticType>>&)>;
    ...
    class IQuantizationConfig {
        public:
             ...
             */
            virtual std::unique_ptr<IQuantizationFactory> createQuantizationFactory(
