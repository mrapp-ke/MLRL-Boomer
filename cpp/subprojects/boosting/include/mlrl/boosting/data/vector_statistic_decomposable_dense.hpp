...
namespace boosting {
    ...
    class DenseDecomposableStatisticVector final
        ...
        public:
             ...
             */
            void add(const CContiguousView<Statistic<float64>>& view, uint32 row, uint32 weight);
             ...
             * @param weight    The weight, the gradients and Hessians should be multiplied by
             */
            void remove(const CContiguousView<Statistic<float64>>& view, uint32 row, uint32 weight);
