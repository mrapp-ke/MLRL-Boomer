...
namespace boosting {
     ...
     * non-decomposable.
     */
    class NonDecomposableSquaredHingeLossConfig final : public INonDecomposableLossConfig {
        private:
        ...
        public:
             ...
             */
            NonDecomposableSquaredHingeLossConfig(const std::unique_ptr<IHeadConfig>& headConfigPtr);
