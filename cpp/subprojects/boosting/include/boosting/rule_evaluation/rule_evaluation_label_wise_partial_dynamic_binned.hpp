...
namespace boosting {
     ...
     * of partial rules, which predict for a subset of the available labels that is determined dynamically, using
     * gradient-based label binning.
     */
    class LabelWiseDynamicPartialBinnedRuleEvaluationFactory final : public ILabelWiseRuleEvaluationFactory {
