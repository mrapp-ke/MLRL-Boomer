...
TARGETS = TargetBuilder(BuildUnit.for_file(__file__)) \
    .add_phony_target('format') \
        .depends_on(FORMAT_PYTHON, FORMAT_CPP, FORMAT_MARKDOWN, FORMAT_YAML, FORMAT_TOML) \
        .nop() \
    .add_phony_target('test_format') \
       .depends_on(TEST_FORMAT_PYTHON, TEST_FORMAT_CPP, TEST_FORMAT_MARKDOWN, TEST_FORMAT_YAML, TEST_FORMAT_TOML) \
       .nop() \
    .build()
