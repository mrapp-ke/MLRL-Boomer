...
class CheckYamlCodeStyle(PhonyTarget.Runnable):
    ...
    def run(self, build_unit: BuildUnit, module: Module):
        ...
        Log.info(f'Checking YAML files in the directory "{code_module.root_directory}"...')
...
class EnforceYamlCodeStyle(PhonyTarget.Runnable):
    ...
    def run(self, build_unit: BuildUnit, module: Module):
        code_module = cast(CodeModule, module)
        Log.info(f'Formatting YAML files in the directory "{code_module.root_directory}"...')
