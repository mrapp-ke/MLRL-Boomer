...
TARGETS = (
    ...
    .add_phony_target('print_cibuildwheel_identifiers')
    .set_functions(print_cibuildwheel_identifiers)
    .add_phony_target('print_cibuildwheel_python_versions')
    .set_functions(print_cibuildwheel_python_versions)
    .build()
)
